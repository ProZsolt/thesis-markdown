...
FILENAME = thesis
TITLE = Felhő alkalmazások automatikus skálázási algoritmusainak benchmarkolása
AUTHOR = Prontvai Zsolt
ADVISOR = Kocsis Imre
...
SOURCE_FILES = abstract.md chapter1.md chapter2.md chapter3.md chapter4.md chapter5.md chapter6.md chapter7.md chapter8.md chapter9.md chapter10.md chapter11.md chapter12.md summary.md acknowledgements.md bibliography.md
